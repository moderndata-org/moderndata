...
<template>
  <div class="pt-[50px]">
    ...
    >
          ...
          <div class="flex w-[37%] large:w-[100%]">
            ...
            <div class="w-[72%] bg-secondry pb-[80px] text-white large:w-[85%]">
              ...
              <p class="pl-[30px] pr-[15px] text-[17px] leading-[30px]">
                ...
                تأسیس گردیده است. ما با تکیه بر تجربه و تخصصی که در این حوزه
                بدست آورده‌ایم، تلاش می‌کنیم تا بهترین و جذاب‌ترین راهکارهای
                نرم‌افزاری را برای مشتریان خود ارائه دهیم. تیم ما از افرادی با
                استعداد و متخصص تشکیل شده است که در تمامی مراحل تولید، از طراحی
                تا پیاده‌سازی، با انگیزه بالا و بهبود پایدار به کار می‌پردازند.
                ما به ارائه راهکارهای نوآورانه، قابلیت های کاربردی و طراحی بصری
                جذاب در اپلیکیشن‌ها و بازی‌های موبایلی خود متعهد هستیم. از زمان
                تأسیس، شرکت ما در زمینه طراحی و تولید اپلیکیشن‌ها و بازی‌های
                موبایلی به ارائه خدمات به مشتریان در داخل و خارج از کشور
                می‌پرداخته است. ما افتخار می کنیم که با همکاری با شرکت‌ها و
                سازمان‌های مختلف، نیازهای نرم‌افزاری آن‌ها را برآورده نموده و به
                بهبود عملکرد و رشد کسب و کار آن‌ها کمک کرده‌ایم.
              </p>
            </div>
          </div>
          <div
        ...
        >
          <SwiperSlide v-for="item in crasoulData" :key="slide">
            ...
            >
              ...
              >
                <div
                  class="relative flex items-center justify-around pb-[20px]"
                >
                  <p
      ...
      <section class="section z-10 bg-secondry *:z-10 large:flex-col">
